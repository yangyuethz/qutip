...
param_probe={'Omega':0.05,
    'sigma': 0.5,
    'duration':10,
    'amplitude_starkshift':0.5}

qb5d97_simulation.t_list=np.linspace(0.01,20,100)
# qb5d97_simulation.swap_time_list=[]
...
for i in range(10):
    ...
    qb5d97_simulation.swap_time_list.append(qb5d97_simulation.fit_result[-1]['swap_time'])
